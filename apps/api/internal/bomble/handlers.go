...
type HandlerFunc func(http.ResponseWriter, *http.Request, common.AppEnv)
...
func MakeHandler(appEnv common.AppEnv, fn func(http.ResponseWriter, *http.Request, common.AppEnv)) http.HandlerFunc {
